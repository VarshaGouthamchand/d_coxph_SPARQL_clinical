...
endpoint = "http://localhost:7203/repositories/userRepo/statements"
...
INSERT  
    ...
    GRAPH <http://annotation2.local/>
    {
     ...
     db:clinical_data_list_opc_v3.dataset rdf:type owl:Class.
    
     db:clinical_data_list_opc_v3.dataset dbo:table db:clinical_data_list_opc_v3.
    
     db:clinical_data_list_opc_v3.dataset rdfs:label "Dataset".
     
     db:clinical_data_list_opc_v3.dataset owl:equivalentClass ncit:C25474.
    
     ?tablerow dbo:has_column ?dataset.

     ?dataset dbo:has_cell ?datavalue.

     ?datavalue dbo:has_value "OPC".
    
     ?dataset rdf:type db:clinical_data_list_opc_v3.dataset.  
        
     ?datavalue rdf:type dbo:Cell.
     
     ?tablerow roo:has ?survivaldays.
     
     db:clinical_data_list_opc_v3.interval_from_the_date_of_diagnosis_to_the_date_of_last_fu_days owl:equivalentClass roo:overallsurvivaldays.
...
where 
{
    ...
    ?tablerow rdf:type db:clinical_data_list_opc_v3.
    
    ?tablerow dbo:has_column ?survivaldays.
    
    ?survivaldays rdf:type db:clinical_data_list_opc_v3.interval_from_the_date_of_diagnosis_to_the_date_of_last_fu_days.
